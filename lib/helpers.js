...
function nameCleaner(name, output="medium") {
  if (name.toString().includes('CDU') && output === "medium") {
    return `CDU/CSU`;
  } else if (name.toString().includes('CDU') && output === "small") {
    return `CDU`;
  } else if (name.toString().includes('GRÜNE') && output === "medium") {
    return `Grüne`;
  } else if (name.toString().includes('GRÜNE') && output === "small") {
      return `Gr`;
  } else if (name.toString().includes('LINKE') && output === "medium") {
    return `Linke`;
  } else if (name.toString().includes('LINKE') && output === "small") {
    return `Lnk`;
  }
  return name;
}
