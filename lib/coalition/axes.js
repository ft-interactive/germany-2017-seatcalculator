...
function makeStackedAxes(){
  ...
  function axes(parent){
    ...
    parent.select('#x-axis .tick.highlight')
      .append("image")
      .attr("xlink:href", "https://www.ft.com/__origami/service/image/v2/images/raw/fticon-v1:arrow-down%3Fcache-bust%3D2504672?width=24&source=origami-registry&tint=66605C")
      .attr("x", -12)
      .attr("y", -12)
      .attr("width", "24px");
